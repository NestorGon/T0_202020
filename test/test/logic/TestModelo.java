...
public class TestModelo 
{
	...
	public void testAgregar() 
	{
		...
		assertTrue( modelo.buscar( "322" ).equals( "322" ) );
	}
	...
	public void testBuscar() 
	{
		...
		assertTrue( modelo.buscar( "55" ).equals( "55" ) );
		assertTrue( modelo.buscar( "1" ).equals( "1" ) );
		assertTrue( modelo.buscar( "-1" ) == null);
	...
	public void testEliminar() 
	{
		...
		assertTrue( modelo.eliminar( "28" ).equals( "28" ) );
